...
.. code-block:: html
    ...
    <script type="text/javascript" 
       src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.2.0/MathJax.js">
    </script>
...
.. code-block:: html
    ...
    <script type="text/javascript" 
       src="https://examples.com/MathJax.js?config=TeX-AMS_HTML,http://myserver.com/MathJax/config/local/local.js">
    </script>
